    ...
    <div className="space-y-6" id="docs-content">
      ...
      <div className="min-w-0">
        <div className="flex gap-2">
          <i className="flex-none size-10 rounded-full p-1.5 flex items-center text-sm bg-white text-gray-500 object-cover ring-1 ring-gray-900/10">
        ...
        <div className="mt-1.5 flex flex-row flex-wrap gap-x-3 gap-y-1 min-w-0 text-sm text-gray-500">
          <div className="flex-none flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="mr-1 h-4 w-4 shrink-0 text-gray-500">
          ...
          <div className="flex-none flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="mr-1 h-4 w-4 shrink-0 text-gray-400">
