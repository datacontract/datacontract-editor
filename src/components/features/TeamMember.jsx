      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          {!isUsernameHidden && (
            <ValidatedInput
              ...
              label={usernameOverride?.title || t('teamMember.username.label')}
          ...
          <div>
              ...
              <div className="flex gap-2 items-end">
                <div className="flex-1">
                  <ValidatedInput
                    ...
                    label={nameOverride?.title || t('teamMember.name.label')}
                    value={member.name || ''}
            ...
            <div>
              <label className="block text-xs font-medium leading-4 text-gray-900 mb-1">
                {t('teamMember.description.label')}
              </label>
              <textarea
                ...
                placeholder={t('teamMember.description.placeholder')}
                rows={2}
              />
            </div>
          )}
          ...
          {!isRoleHidden && (
            <ValidatedInput
              ...
              label={roleOverride?.title || t('teamMember.role.label')}
              value={member.role || ''}
              onChange={(e) => onUpdate(index, 'role', e.target.value)}
              placeholder={roleOverride?.placeholder || t('teamMember.role.placeholder')}
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
          {!isDateInHidden && (
            <div>
              <label className="block text-xs font-medium leading-4 text-gray-900 mb-1">
                {dateInOverride?.title || t('teamMember.dateIn.label')}
              </label>
              <input
                type="date"
                value={member.dateIn || ''}
          ...
          {!isDateOutHidden && (
            <div>
              <label className="block text-xs font-medium leading-4 text-gray-900 mb-1">
                {dateOutOverride?.title || t('teamMember.dateOut.label')}
              </label>
              <input
                type="date"
          ...
          <ValidatedInput
            ...
            label={t('teamMember.replacedBy.label')}
        ...
        {/* Tags */}
        <TagsInput
          label={t('teamMember.tags.label')}
          value={member.tags || []}
          onChange={(value) => onUpdate(index, 'tags', value)}
          placeholder={t('teamMember.tags.placeholder')}
        />
