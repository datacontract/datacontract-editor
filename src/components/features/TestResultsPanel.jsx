    ...
    return (
      <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
        ...
        <div className="text-sm text-blue-800 dark:text-blue-300 space-y-2">
          <p>To run the Data Contract API server, use the following command:</p>
          <div className="bg-gray-900 text-gray-100 p-2 rounded font-mono text-xs">
            $ datacontract api
          </div>
          <p>The API runs on <span className="font-semibold">port 4242</span> by default at <span className="font-mono">http://localhost:4242</span>.</p>
          <p>
        ...
        <div className="p-4 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          ...
          <div className="mt-2 flex items-center justify-between">
            <div className="text-xs text-gray-500 dark:text-gray-400">
              Connected to Data Contract CLI via: <a href="http://localhost:4242" target="_blank" rel="noopener noreferrer" className="font-mono text-blue-600 dark:text-blue-400 hover:underline">http://localhost:4242</a>
            </div>
            <button
