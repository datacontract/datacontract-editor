      ...
      <div className="space-y-1">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 rounded-md border-0 py-1.5 pl-2 pr-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 text-xs leading-4"
